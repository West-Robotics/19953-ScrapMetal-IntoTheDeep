...
class PathingTest {
    ...
    fun testClosestT() {
        val spline = Spline(
            ...
            startTangent = Vector2d(26.0, 10.0),
            end = Vector2d(24.0, 2.0),
            endTangent = Vector2d(0.0, 40.0),
        )
        repeat (1000) {
            val pos = Vector2d(
    ...
    fun testMovementBuilder() {
        val movement = SplinePoint(0.0, 0.0, 26.0, 10.0) to
                SplinePoint(24.0, 2.0, 0.0, 40.0) withHeading Constant(10.0) to
                SplinePoint(1.0, 2.0, 3.0, 4.0) to
                SplinePoint(5.0, 6.0, 7.0, 8.0) withEffort 0.2 to
                SplinePoint(9.0, 10.0, 11.0, 2.0) withHeading Linear(10.0, 180.0) withEffort 0.5

        assertEquals(movement.submovements.size, 4)
        assertEquals(
            movement.submovements[0],
            SubMovement(
                Spline(Vector2d(0.0, 0.0), Vector2d(26.0, 10.0), Vector2d(24.0, 2.0), Vector2d(0.0, 40.0)),
                Constant(10.0),
                1.0,
            )
        )
        assertEquals(
            ...
            SubMovement(
                Spline(Vector2d(24.0, 2.0), Vector2d(0.0, 40.0), Vector2d(1.0, 2.0), Vector2d(3.0, 4.0)),
                Tangent(Spline(Vector2d(24.0, 2.0), Vector2d(0.0, 40.0), Vector2d(1.0, 2.0), Vector2d(3.0, 4.0))),
                1.0,
            )
        )
        assertEquals(
            ...
            SubMovement(
                Spline(Vector2d(1.0, 2.0), Vector2d(3.0, 4.0), Vector2d(5.0, 6.0), Vector2d(7.0, 8.0)),
                Tangent(Spline(Vector2d(1.0, 2.0), Vector2d(3.0, 4.0), Vector2d(5.0, 6.0), Vector2d(7.0, 8.0))),
                0.2,
            )
        )
        assertEquals(
            ...
            SubMovement(
                Spline(Vector2d(5.0, 6.0), Vector2d(7.0, 8.0), Vector2d(9.0, 10.0), Vector2d(11.0, 2.0)),
                Linear(10.0, 180.0),
                0.5,
            )
        )
