...
data class Linear(private val start: Rotation2d, private val end: Rotation2d) : HeadingInterpolation {
    constructor(theta0: Double, theta1: Double) : this(Rotation2d(theta0), Rotation2d(theta1))
    override fun invoke(t: Double) = Rotation2d(end.theta*t)*start
}