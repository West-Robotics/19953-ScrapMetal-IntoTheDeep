...
// import org.firstinspires.ftc.teamcode.ninth.opmode.auto.ZeroPlusSevenManual.AutoState.*
// import kotlin.math.abs
//
// @Autonomous(name="0+7 Manual")
// class ZeroPlusSevenManual : LinearOpMode() {
...
//     }
//
//     data class SampleEntry(val p: Vector2d, val ang: Double)
//
...
//         val samps = mutableListOf<SampleEntry>()
...
//                             SplinePoint(Vector2d(72.0, 72.0) - Vector2d(22.0, 0.0) + samps[sampCount - 4]., Vector2d(30.0, 0.0)) withHeading Linear(score.heading, Rotation2d(180.0))
//                 )
//                 lift.preset = BOTTOM
//             }
//             .transition({ lift.height < 12.0 }, { sampler.state = EXTING_SAMP })
