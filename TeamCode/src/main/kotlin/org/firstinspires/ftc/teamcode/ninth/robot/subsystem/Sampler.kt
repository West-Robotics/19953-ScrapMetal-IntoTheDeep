...
//    val W_HOLDING = 0.0
    ...
    enum class State(val grabber: Double, val pivot: Double, val wrist: Double,  val linkage: Double) {
        EXTEND(0.00, 0.43, 0.0, 0.68),
        GRAB_SAMPLE(1.00, 0.03, 0.0, 0.68),
        GRAB_SPECIMEN (1.00, 0.03, 0.0, 0.00),
        SPIT(-1.00, 0.03, 0.0, 0.68),
        STOW(0.00, 0.43, 0.0, 0.00),
//        RETRACT(0.0, 0.43, 0.0),
        HOLD(0.10, 0.43, 0.0,0.00),
